...
export class OrderStatusService {
  ...
  async orderStatusExists (id: number) {
    ...
    if (!orderStatus) { throw new HttpException('Order status does not exist', HttpStatus.NOT_FOUND) }
  }
  ...
  async orderStatusDuplicated (name: string) {
    ...
    if (orderStatus) { throw new HttpException('Order status already exists', HttpStatus.CONFLICT) }
  }
}
...
export class ActivityStatusService {
  ...
  async activityStatusExists (id: number) {
    ...
    if (!activityStatus) { throw new HttpException('Activity status does not exist', HttpStatus.NOT_FOUND) }
  }
  ...
  async activityStatusDuplicated (name: string) {
    ...
    if (activityStatus) { throw new HttpException('Activity status already exists', HttpStatus.CONFLICT) }
  }
  ...
  async activityStatusInUse (id: number) {
    ...
    if (activityStatus.name !== 'pending') { throw new HttpException('Activity status is in use', HttpStatus.CONFLICT) }
  }
}
